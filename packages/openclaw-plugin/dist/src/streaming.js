 ...
 */
export async function handleBlockReply(client, chatId, agentId, dispatchId, payload) {
 ...
 */
export async function finalizeStream(client, dispatchId, finalText) {
 ...
 */
export function cancelStream(client, dispatchId) {
    const stream = activeStreams.get(dispatchId);
    if (stream) {
 ...
 */
export function initStream(dispatchId, chatId, messageId, agentId) {
 ...
 * Useful for testing.
 */
export function hasActiveStream(dispatchId) {
 ...
 */
export function cancelAllStreamsForChat(client, chatId) {
 ...
 */
export function clearActiveStreamsForTests() {
    activeStreams.clear();
}
