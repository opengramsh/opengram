...
const ChoiceConfig = Type.Object({
    options: Type.Array(Type.Object({
        ...
        variant: Type.Optional(Type.Union([Type.Literal("primary"), Type.Literal("danger"), Type.Literal("default")], {
            description: 'Button style: "primary" = suggested, "danger" = destructive',
        })),
    }), { description: "Choice options (buttons)" }),
    maxSelections: Type.Optional(Type.Number({ description: "Max selections allowed (default: 1)" })),
...
const FormFieldSchema = Type.Object({
    ...
    options: Type.Optional(Type.Array(Type.String(), { description: "Options for select/multiselect fields" })),
});
...
export const opengramRequestTool = {
    ...
    parameters: Type.Object({
        ...
        config: Type.Union([ChoiceConfig, TextInputConfig, FormConfig], {
            description: "Type-specific config. Must match the chosen type: " +
