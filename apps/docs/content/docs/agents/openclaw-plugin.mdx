...
### Reimporting your OpenClaw agents

If you've added new agents in OpenClaw and want to link them to Opengram, run the setup wizard again:

```bash
openclaw opengram setup
```

The wizard will detect all available OpenClaw agents and let you choose which ones to import. Previously linked agents remain selected by default -- you can add new ones or remove existing ones from the selection.
