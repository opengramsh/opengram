...
If the [OpenClaw plugin](/docs/integrations/openclaw) is installed, it is upgraded
automatically as well and you will be prompted to restart the OpenClaw gateway.
