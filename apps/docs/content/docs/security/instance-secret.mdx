...
This is especially useful for Docker deployments where you can pass it via `-e` or `env_file` without modifying `opengram.config.json`. See [Environment Variables](/docs/reference/environment-variables) for the full list.
